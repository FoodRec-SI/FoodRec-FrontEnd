        ...
        <div className="flex flex-column gap-2 mb-3">
          ...
          <div style={{ alignSelf: "center", width: "70%" }}>
            {ingredients.map((ingredient, index) => (
              <div key={ingredient} className="ingredient-item" style={{ padding: "10px 0px", boxSizing: "border-box", display: "flex", justifyContent: "space-between" }}>
                <InputText
                  className={classNames({
